...
The `l2path` package contains implementation of path-following algorithms for both ridge regression and  <pre xml:lang="latex">\ell_2</pre>-regularized logistic regression.
